...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.usefathom.com ${vercelLiveSources.join(" ")}`.trim(),
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: https://cdn.usefathom.com",
      "font-src 'self'",
      `connect-src 'self' https://cdn.usefathom.com https://api.usefathom.com ${vercelLiveSources.join(" ")}`.trim(),
...
const docsSecurityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://cdn.usefathom.com https://mintcdn.com https://*.mintcdn.com https://d3gk2c5xim1je2.cloudfront.net https://cdn.jsdelivr.net https://mintlify.s3.us-west-1.amazonaws.com",
      "font-src 'self' https://cdn.jsdelivr.net https://d4tuoctqmanu0.cloudfront.net https://fonts.googleapis.com",
      `connect-src 'self' https://cdn.usefathom.com https://api.usefathom.com https://api.mintlifytrieve.com https://*.mintlify.dev https://*.mintlify.com https://d1ctpt7j8wusba.cloudfront.net https://mintcdn.com https://*.mintcdn.com https://leaves.mintlify.com ${vercelLiveSources.join(" ")}`.trim(),
