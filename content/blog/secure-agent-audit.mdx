...
## The problem with standard agent logging
...
This post describes how [nono](https://nono.sh) does each of these, walks through the crypto well enough that "Merkle tree" and "inclusion proof" finally make sense, and shows why the combination makes nono a solution well purposed for agents in highly regulated environments.
...
p.s. If you have never read the [Bitcoin whitepaper](https://bitcoin.org/bitcoin.pdf), you should. It is a masterpiece of clear writing, brilliant design and engineering. The Merkle tree section is only a few paragraphs but it is worth the whole read. 

### Inclusion proofs: one value, no full replay

Here is the quiet superpower of merkle trees. If I give you the Merkle root and then later claim "event #3 really was in the log" — I don't have to show you the whole log to prove it. I just have to show you:
