...
date: "2026-06-09"
description: "How runseal wraps your release step in a kernel-level sandbox, injects phantom credentials, and blocks the network to stop supply-chain attacks that rely on untrusted code running in CI/CD."
author: "Luke Hinds"
